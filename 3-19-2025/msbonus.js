...
<script>
  $(document).ready(function () {
    ...
    $(
      ".group1, .monamaxcupgroup, .group2, .group3, .group4, .japangroup1, .malaysiagroup1, .thaigroup1, .vietnamgroup2, .chinagroup1, .chinagroup3, .spaingroup1, .indiagroup1, .indiagroup2, .indiagroup3, .indiagroup4"
    ).hide();
    ...
    function removeIrrelevantContent(countryCode) {
      ...
      if (countriesEligibleForCup.includes(countryCode)) {
        ...
        $(".malaysiagroup1").show();
        $(".malaysiagroup1 section.recurring").remove();
      } else {
        $(".group3").show();
