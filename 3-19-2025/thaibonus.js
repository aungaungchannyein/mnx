<script>
    $(document).ready(function () {
      ...
      var globalLatamBrazil = [
   "AG","AI","AR","AW","BB","BM","BO","BR","BS","BZ","CL","CO","CR","CU","DM","DO","EC","FK","GD","GT","GY","HN","HT","JM","KN","KY","LC","MS","MX","NI","PA","PE","PR","PY","SR","SV","TC","TT","UY","VC","VE","VG","VI","ES","PT"
];
      ...
      $(
        ".group1,.bonus200LatamBrazil, .monamaxcupgroup, .maxgroup1, .group2, .group3, .group4, .japangroup1, .malaysiagroup1, .thaigroup1, .thaigroup12, .vietnamgroup2, .chinagroup1, .chinagroup3, .spaingroup1, .indiagroup1, .indiagroup2, .indiagroup3, .indiagroup4"
      ).hide();
      ...
      function removeIrrelevantContent(countryCode) {
        ...
        if (countryCode === "CN") {
            $(".chinagroup3").show();
            $(".chinagroup3 section.recurring").remove();
          } else if(countryCode =="VN"){
          $(".vietnamgroup2").show();
          $(".vietnamgroup2 section.recurring").remove();
      }else if (globalLatamBrazil.includes(countryCode)) {
          $(".bonus200LatamBrazil").show();
        } else if (countriesEligibleForCup.includes(countryCode)) {
          $(".monamaxcupgroup").show();
        } else if (globalGroup1.includes(countryCode)) {
          $(".group1").show();
          ...
          $(".thaigroup1").show();
          $(".thaigroup1 section.recurring").remove();
